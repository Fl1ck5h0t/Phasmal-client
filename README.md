...
### _Secure cascading VPN client with advanced obfuscation_


[![Build Status](https://github.com/Fl1ck5h0t/Phasmal-client/actions/workflows/deploy.yml/badge.svg?branch=dev)](https://github.com/Fl1ck5h0t/Phasmal-client/actions/workflows/deploy.yml?query=branch:dev)
[![Gitpod ready-to-code](https://img.shields.io/badge/Gitpod-ready--to--code-blue?logo=gitpod)](https://gitpod.io/#https://github.com/Fl1ck5h0t/Phasmal-client)

### [English]([https://github.com/Fl1ck5h0t/Phasmal-client/blob/dev/README_RU.md](https://github.com/Fl1ck5h0t/Phasmal-client/tree/dev?tab=readme-ov-file#)) | [Русский](https://github.com/Fl1ck5h0t/Phasmal-client/blob/dev/README_RU.md)


[Amnezia](https://phasmalvpn.com?utm_source=github&utm_campaign=amnezia_website-readme-en) is an open-source VPN client, with a key feature that enables you to deploy your own VPN server on your server.

[![Image](https://github.com/Fl1ck5h0t/Phasmal-client/blob/dev/metadata/img-readme/uipic4.png)](https://phasmalvpn.com)

### [Website](https://phasmalvpn.com?utm_source=github&utm_campaign=amnezia_website-readme-en) | [Alt website link](https://storage.googleapis.com/amnezia/phasmalvpn.com?utm_source=github&utm_campaign=amnezia_website-readme-en-mirror) | [Documentation](https://docs.phasmalvpn.com) | [Troubleshooting](https://docs.phasmalvpn.com/troubleshooting)

> [!TIP]
> If the [Amnezia website](https://phasmalvpn.com?utm_source=github&utm_campaign=amnezia_website-readme-en) is blocked in your region, you can use an [Alternative website link](https://storage.googleapis.com/amnezia/phasmalvpn.com?utm_source=github&utm_campaign=amnezia_website-readme-en-mirror).

<a href="https://phasmalvpn.com/en/downloads?utm_source=github&utm_campaign=amnezia_button-readme-en"><img src="https://github.com/Fl1ck5h0t/Phasmal-client/blob/dev/metadata/img-readme/download-website.svg" width="150" style="max-width: 100%; margin-right: 10px"></a>
<a href="https://storage.googleapis.com/amnezia/phasmalvpn.com?m-path=/en/downloads&utm_source=github&utm_campaign=amnezia_button-readme-en-mirrow"><img src="https://github.com/Fl1ck5h0t/Phasmal-client/blob/dev/metadata/img-readme/download-alt.svg" width="150" style="max-width: 100%;"></a>

[All releases](https://github.com/Fl1ck5h0t/Phasmal-client/releases)

<br/>

<a href="https://www.testiny.io"><img src="https://github.com/Fl1ck5h0t/Phasmal-client/blob/dev/metadata/img-readme/testiny.png" height="28px"></a>
...
- Protocols with traffic Masking (Obfuscation): OpenVPN over [Cloak](https://github.com/cbeuw/Cloak) plugin, Shadowsocks (OpenVPN over Shadowsocks), [AmneziaWG](https://docs.phasmalvpn.com/documentation/amnezia-wg/) and XRay.
...
- [https://phasmalvpn.com](https://phasmalvpn.com) - Project website | [Alternative link (mirror)](https://storage.googleapis.com/kldscp/phasmalvpn.com)
- [https://docs.phasmalvpn.com](https://docs.phasmalvpn.com) - Documentation
- [https://www.reddit.com/r/PhasmalVPN](https://www.reddit.com/r/PhasmalVPN) - Reddit  
...
PhasmalVPN uses several open-source projects to work:
...
Go to ["Actions" tab](https://github.com/Fl1ck5h0t/Phasmal-client/actions?query=is%3Asuccess+branch%3Adev), click on the first line.
Then scroll down to the "Artifacts" section and download "PhasmalVPN_translations".
...
* To use `Xcode`, you have to configure project first by using `cmake`. The easiest way to do it is to use `Qt Creator` for configuration. Then open `PhasmalVPN.xcodeproj` file from the build folder by using `Xcode`. Note that none of the files changed are saved - the files actually getting changed in build directory. Copy them manually if necessary
...
Patreon: [https://www.patreon.com/PhasmalVPN](https://www.patreon.com/PhasmalVPN)
