set(CPACK_PACKAGE_VENDOR            PhasmalVPN)
set(CPACK_PACKAGE_VERSION           ${PhasmalVPN_VERSION})
if(WIN32)
    set(CPACK_PACKAGE_FILE_NAME "PhasmalVPN_${PhasmalVPN_VERSION}_windows_x64")
elseif(APPLE AND NOT IOS AND NOT MACOS_NE)
    set(CPACK_PACKAGE_FILE_NAME "PhasmalVPN_${PhasmalVPN_VERSION}_macos_x64")
elseif(LINUX AND NOT ANDROID)
    set(CPACK_PACKAGE_FILE_NAME "PhasmalVPN_${PhasmalVPN_VERSION}_linux_x64")
endif()
set(CPACK_PACKAGE_INSTALL_DIRECTORY PhasmalVPN)
set(CPACK_PACKAGE_EXECUTABLES       PhasmalVPN PhasmalVPN)
...
list(PREPEND CPACK_COMPONENTS_ALL PhasmalVPN)
...
set(CPACK_IFW_PACKAGE_NAME                          PhasmalVPN)
set(CPACK_IFW_PACKAGE_TITLE                         PhasmalVPN)
...
set(CPACK_PRODUCTBUILD_IDENTIFIER       com.phasmalvpn)
set(CPACK_PREFLIGHT_PhasmalVPN_SCRIPT   ${CMAKE_SOURCE_DIR}/deploy/data/macos/post_uninstall.sh)
set(CPACK_POSTFLIGHT_PhasmalVPN_SCRIPT  ${CMAKE_SOURCE_DIR}/deploy/data/macos/post_install.sh)
...
if(LINUX AND NOT ANDROID)
    install(FILES
        ${CMAKE_SOURCE_DIR}/deploy/data/linux/PhasmalVPN.service
        ${CMAKE_SOURCE_DIR}/deploy/data/linux/PhasmalVPN.png
        ${CMAKE_SOURCE_DIR}/deploy/data/linux/PhasmalVPN.desktop
        ${CMAKE_SOURCE_DIR}/deploy/data/linux/post_install.sh
        ${CMAKE_SOURCE_DIR}/deploy/data/linux/post_uninstall.sh
        DESTINATION "."
        COMPONENT PhasmalVPN
    )
endif()
...
if (APPLE AND NOT IOS AND NOT MACOS_NE)
    install(FILES ${CMAKE_SOURCE_DIR}/deploy/data/macos/PhasmalVPN.plist
        DESTINATION "PhasmalVPN.app/Contents/Resources"
        COMPONENT PhasmalVPN
    )
endif()

include(CPackIFW)
cpack_ifw_configure_component(PhasmalVPN
    VERSION ${PhasmalVPN_VERSION}
...
cpack_add_component(Uninstall
    DISPLAY_NAME "Uninstall PhasmalVPN"
    REQUIRES_ADMIN_RIGHTS
    DISABLED
)
