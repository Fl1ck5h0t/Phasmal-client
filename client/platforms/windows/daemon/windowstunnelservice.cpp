...
#define TUNNEL_NAMED_PIPE \
  "\\\\."                 \
  "\\pipe\\ProtectedPrefix\\Administrators\\AmneziaWG\\PhasmalVPN"
...
bool WindowsTunnelService::start(const QString& configData) {
  ...
  service = CreateService(scm, TUNNEL_SERVICE_NAME, L"Phasmal VPN (tunnel)",
  ...
  SERVICE_DESCRIPTION sd = {
      (wchar_t*)L"Manages the Phasmal VPN tunnel connection"};
