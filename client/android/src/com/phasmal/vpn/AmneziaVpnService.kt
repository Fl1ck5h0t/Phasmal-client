...
import com.phasmal.vpn.protocol.BadConfigException
...
import com.phasmal.vpn.protocol.VpnException
import com.phasmal.vpn.protocol.VpnStartException
import com.phasmal.vpn.protocol.putStatus
import com.phasmal.vpn.util.LoadLibraryException
import com.phasmal.vpn.util.Log
import com.phasmal.vpn.util.Prefs
import com.phasmal.vpn.util.net.NetworkState
import com.phasmal.vpn.util.net.TrafficStats
import org.json.JSONException
import org.json.JSONObject

private const val TAG = "PhasmalVPNService"

const val ACTION_DISCONNECT = "com.phasmal.vpn.action.disconnect"
const val ACTION_CONNECT = "com.phasmal.vpn.action.connect"
...
open class PhasmalVPNService : VpnService() {
                        ...
                        clientMessengers[msg.replyTo]?.let { clientMessenger ->
                            clientMessenger.send {
                                ServiceEvent.STATUS.packToMessage {
                                    putStatus(this@PhasmalVPNService.protocolState.value)
                                }
                            }
                        }
                    }
    ...
    override fun onCreate() {
        super.onCreate()
        Log.d(TAG, "Create Phasmal VPN service")
