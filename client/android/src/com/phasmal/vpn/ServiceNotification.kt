...
import com.phasmal.vpn.util.net.TrafficStats.TrafficData

private const val TAG = "ServiceNotification"

private const val OLD_NOTIFICATION_CHANNEL_ID: String = "com.phasmal.vpn.notification"
private const val NOTIFICATION_CHANNEL_ID: String = "com.phasmal.vpn.notifications"
...
class ServiceNotification(private val context: Context) {
    ...
    fun buildNotification(serverName: String?, protocol: String?, state: ProtocolState): Notification {
        ...
        return notificationBuilder
            ...
            .setContentTitle((serverName ?: "PhasmalVPN") + (protocol?.let { " $it" } ?: ""))
