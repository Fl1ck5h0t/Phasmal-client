...
if(DEFINED DEPLOY)
    set_target_properties(${PROJECT} PROPERTIES
        ...
        XCODE_ATTRIBUTE_PROVISIONING_PROFILE_SPECIFIER "distr ios.com.phasmal.PhasmalVPN"
        XCODE_ATTRIBUTE_PROVISIONING_PROFILE_SPECIFIER[variant=Debug] "dev ios.com.phasmal.PhasmalVPN"
    )
else()
    set_target_properties(${PROJECT} PROPERTIES
...
target_sources(${PROJECT} PRIVATE
    ${CMAKE_CURRENT_SOURCE_DIR}/ios/app/PhasmalVPNLaunchScreen.storyboard
