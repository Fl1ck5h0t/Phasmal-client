...
set_target_properties(${PROJECT} PROPERTIES
    ...
    MACOSX_BUNDLE_INFO_STRING "PhasmalVPN"
    MACOSX_BUNDLE_BUNDLE_NAME "PhasmalVPN"
    ...
    XCODE_ATTRIBUTE_PRODUCT_NAME "PhasmalVPN"
    XCODE_ATTRIBUTE_BUNDLE_INFO_STRING "PhasmalVPN"
    ...
    XCODE_EMBED_APP_EXTENSIONS PhasmalVPNNetworkExtension
)
...
if(DEPLOY)
    set_target_properties(${PROJECT} PROPERTIES
        ...
        XCODE_ATTRIBUTE_PROVISIONING_PROFILE_SPECIFIER "distr macos.com.phasmal.PhasmalVPN"
        XCODE_ATTRIBUTE_PROVISIONING_PROFILE_SPECIFIER[variant=Debug] "dev macos.com.phasmal.PhasmalVPN"
    )
else()
    set_target_properties(${PROJECT} PROPERTIES
...
set_target_properties(${PROJECT} PROPERTIES
    ...
    XCODE_ATTRIBUTE_SWIFT_OBJC_INTERFACE_HEADER_NAME "PhasmalVPN-Swift.h"
...
add_dependencies(${PROJECT} PhasmalVPNNetworkExtension)
...
add_custom_command(TARGET ${PROJECT} POST_BUILD
    COMMAND ${QT_BIN_DIR_DETECTED}/macdeployqt $<TARGET_BUNDLE_DIR:PhasmalVPN> -appstore-compliant -qmldir=${CMAKE_CURRENT_SOURCE_DIR}
)
