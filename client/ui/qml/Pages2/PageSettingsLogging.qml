...
PageType {
    ...
    QtObject {
        ...
        readonly property string description: qsTr("PhasmalVPN logs")
    ...
    QtObject {
        ...
        readonly property string description: qsTr("PhasmalVPN-service logs")
        ...
        readonly property var exportLogsHandler: function() {
            ...
            fileName = SystemController.getFileName(qsTr("Save"),
                                                    qsTr("Logs files (*.log)"),
                                                    StandardPaths.standardLocations(StandardPaths.DocumentsLocation) + "/PhasmalVPN-service",
                                                    true,
                                                    ".log")
            if (fileName !== "") {
                PageController.showBusyIndicator(true)
