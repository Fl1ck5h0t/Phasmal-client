...
ls /opt/PhasmalVPN/client/lib/* | while IFS=: read -r dir; do
...
if test -f "$LOG_FOLDER/PhasmalVPN-service.log"; then
    sudo rm -f "$LOG_FOLDER/PhasmalVPN-service.log" >> $LOG_FILE 2>&1
fi
